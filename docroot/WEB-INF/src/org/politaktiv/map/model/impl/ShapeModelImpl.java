 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link ShapeModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ShapeImpl}.
 * </p>
 *
...
public class ShapeModelImpl extends BaseModelImpl<Shape> implements ShapeModel {
	...
	static {
		TABLE_COLUMNS_MAP.put("shapeId", Types.BIGINT);
		...
		TABLE_COLUMNS_MAP.put("abstractDescription", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("url", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("shapeType", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("radius", Types.BIGINT);
		TABLE_COLUMNS_MAP.put("layer", Types.VARCHAR);
	}
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
			...
			true);
	public static final long LAYER_COLUMN_BITMASK = 1L;
	...
	public void resetOriginalValues() {
		...
		shapeModelImpl._setModifiedDate = false;
	...
	private static final ClassLoader _classLoader = Shape.class.getClassLoader();
	private static final Class<?>[] _escapedModelInterfaces = new Class[] {
			Shape.class, ModelWrapper.class
		};
