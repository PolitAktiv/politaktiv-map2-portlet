...
public class LayerPersistenceImpl extends BasePersistenceImpl<Layer>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_LABEL = new FinderPath(LayerModelImpl.ENTITY_CACHE_ENABLED,
			LayerModelImpl.FINDER_CACHE_ENABLED, LayerImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByLabel",
			new String[] { String.class.getName() },
			LayerModelImpl.LABEL_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_LABEL = new FinderPath(LayerModelImpl.ENTITY_CACHE_ENABLED,
			LayerModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public Layer findByLabel(String label)
		throws NoSuchLayerException, SystemException {
		Layer layer = fetchByLabel(label);
	 ...
	 */
	@Override
	public Layer fetchByLabel(String label) throws SystemException {
	 ...
	 */
	@Override
	public Layer fetchByLabel(String label, boolean retrieveFromCache)
		throws SystemException {
		...
		if (result instanceof Layer) {
			...
			if (!Validator.equals(label, layer.getLabel())) {
				result = null;
			}
		}
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"LayerPersistenceImpl.fetchByLabel(String, boolean) with parameters (" +
	 ...
	 */
	@Override
	public Layer removeByLabel(String label)
		throws NoSuchLayerException, SystemException {
		Layer layer = findByLabel(label);
	...
	private static final String _FINDER_COLUMN_LABEL_LABEL_1 = "layer.label IS NULL";
	private static final String _FINDER_COLUMN_LABEL_LABEL_2 = "layer.label = ?";
	private static final String _FINDER_COLUMN_LABEL_LABEL_3 = "(layer.label IS NULL OR layer.label = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_USERIDANDLABEL = new FinderPath(LayerModelImpl.ENTITY_CACHE_ENABLED,
			LayerModelImpl.FINDER_CACHE_ENABLED, LayerImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByUserIdAndLabel",
			new String[] { Long.class.getName(), String.class.getName() },
			LayerModelImpl.USERID_COLUMN_BITMASK |
			LayerModelImpl.LABEL_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_USERIDANDLABEL = new FinderPath(LayerModelImpl.ENTITY_CACHE_ENABLED,
			LayerModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUserIdAndLabel",
			new String[] { Long.class.getName(), String.class.getName() });
	 ...
	 */
	@Override
	public Layer findByUserIdAndLabel(long userId, String label)
		throws NoSuchLayerException, SystemException {
		Layer layer = fetchByUserIdAndLabel(userId, label);
	 ...
	 */
	@Override
	public Layer fetchByUserIdAndLabel(long userId, String label)
		throws SystemException {
		return fetchByUserIdAndLabel(userId, label, true);
	}
	...
	public Layer fetchByUserIdAndLabel(long userId, String label,
		...
		Object[] finderArgs = new Object[] { userId, label };

		Object result = null;

		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_USERIDANDLABEL,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_USERIDANDLABEL_USERID_2);

			boolean bindLabel = false;

			if (label == null) {
				query.append(_FINDER_COLUMN_USERIDANDLABEL_LABEL_1);
			}
			else if (label.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_USERIDANDLABEL_LABEL_3);
			}
			else {
				bindLabel = true;

				query.append(_FINDER_COLUMN_USERIDANDLABEL_LABEL_2);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_USERIDANDLABEL,
						finderArgs, list);
				}
				else {
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"LayerPersistenceImpl.fetchByUserIdAndLabel(long, String, boolean) with parameters (" +
							StringUtil.merge(finderArgs) +
							") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
					}
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_USERIDANDLABEL,
					finderArgs);
	 ...
	 */
	@Override
	public Layer removeByUserIdAndLabel(long userId, String label)
		throws NoSuchLayerException, SystemException {
		Layer layer = findByUserIdAndLabel(userId, label);
	 ...
	 */
	@Override
	public int countByUserIdAndLabel(long userId, String label)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_USERIDANDLABEL;
	...
	private static final String _FINDER_COLUMN_USERIDANDLABEL_USERID_2 = "layer.userId = ? AND ";
	private static final String _FINDER_COLUMN_USERIDANDLABEL_LABEL_1 = "layer.label IS NULL";
	private static final String _FINDER_COLUMN_USERIDANDLABEL_LABEL_2 = "layer.label = ?";
	private static final String _FINDER_COLUMN_USERIDANDLABEL_LABEL_3 = "(layer.label IS NULL OR layer.label = '')";
	...
	public void cacheResult(Layer layer) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_LABEL,
			new Object[] { layer.getLabel() }, layer);

		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_USERIDANDLABEL,
			new Object[] { layer.getUserId(), layer.getLabel() }, layer);
	...
	protected void cacheUniqueFindersCache(Layer layer) {
		if (layer.isNew()) {
			Object[] args = new Object[] { layer.getLabel() };

			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_LABEL, args,
				Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_LABEL, args, layer);

			args = new Object[] { layer.getUserId(), layer.getLabel() };

			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_USERIDANDLABEL,
				args, Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_USERIDANDLABEL,
				args, layer);
		}
			...
			if ((layerModelImpl.getColumnBitmask() &
					FINDER_PATH_FETCH_BY_USERIDANDLABEL.getColumnBitmask()) != 0) {
				Object[] args = new Object[] { layer.getUserId(), layer.getLabel() };
	...
	protected void clearUniqueFindersCache(Layer layer) {
		...
		if ((layerModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_LABEL.getColumnBitmask()) != 0) {
			args = new Object[] { layerModelImpl.getOriginalLabel() };
		...
		FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_USERIDANDLABEL, args);
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_USERIDANDLABEL, args);
		...
		if ((layerModelImpl.getColumnBitmask() &
			...
			FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_USERIDANDLABEL,
				args);
			FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_USERIDANDLABEL,
				args);
		}
