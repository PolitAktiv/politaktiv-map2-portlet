...
/**
 * Provides the local service interface for Layer. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Paul Butenko
 * @see LayerLocalServiceUtil
...
public interface LayerLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LayerLocalServiceUtil} to access the layer local service. Add custom service methods to {@link org.politaktiv.map.service.impl.LayerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
